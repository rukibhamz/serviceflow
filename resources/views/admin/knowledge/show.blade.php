    ...
    <article class="mx-auto max-w-3xl">
        ...
        <div class="mt-8 border-t pt-6">
            ...
            <div class="flex gap-3">
                <form method="POST" action="{{ route('admin.knowledge.vote', $article->slug) }}">
                    @csrf
                    <input type="hidden" name="helpful" value="1" />
                    <button type="submit" class="rounded border border-green-300 bg-green-50 px-4 py-2 text-sm text-green-700 hover:bg-green-100">
                ...
                <form method="POST" action="{{ route('admin.knowledge.vote', $article->slug) }}">
                    ...
                    <button type="submit" class="rounded border border-red-300 bg-red-50 px-4 py-2 text-sm text-red-700 hover:bg-red-100">
