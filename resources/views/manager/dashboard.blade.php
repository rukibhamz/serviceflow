...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-2">
        <a href="{{ route('manager.service-catalogue.index') }}" class="btn-ds primary">Service Catalogue</a>
        <a href="{{ route('manager.service-catalogue.create') }}" class="btn-ds ghost">+ New Catalogue Item</a>
    </div>
                ...
                <tbody class="divide-y">
                    @forelse($recentCatalogue as $item)
                        <tr>
                            ...
                            <td class="px-4 py-2 text-right"><a class="text-blue-600 hover:underline" href="{{ route('manager.service-catalogue.edit', $item) }}">Edit</a></td>
                        </tr>
                    @empty
