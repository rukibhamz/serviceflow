...
<body class="bg-gray-100">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var script = document.querySelector('script[data-update-uri]');
            if (script) {
                var uri = script.getAttribute('data-update-uri');
                if (uri && !uri.startsWith('/serviceflow')) {
                    script.setAttribute('data-update-uri', '/serviceflow' + uri);
                }
            }
        });
    </script>
