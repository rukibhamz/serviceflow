<div class="space-y-4">
    ...
    <div class="stats-ds mb-2">
        <div class="stat-card"><div class="stat-label">Total Changes</div><div class="stat-val text-brand">{{ $stats['total'] }}</div></div>
        <div class="stat-card"><div class="stat-label">Pending Approval</div><div class="stat-val text-yellow-500">{{ $stats['pending'] }}</div></div>
        <div class="stat-card"><div class="stat-label">Approved</div><div class="stat-val text-green-600">{{ $stats['approved'] }}</div></div>
        <div class="stat-card"><div class="stat-label">Scheduled</div><div class="stat-val text-blue-500">{{ $stats['scheduled'] }}</div></div>
    </div>
