...
<body class="bg-gray-100">
    ...
    <div class="app-shell">
        ...
        <div class="topnav">
            ...
            <a href="<?php echo e(route('agent.dashboard')); ?>" class="nav-pill <?php echo e(Request::routeIs('agent.dashboard') ? 'active' : ''); ?>">Dashboard</a>
            <a href="<?php echo e(route('agent.tickets.index')); ?>" class="nav-pill <?php echo e(Request::routeIs('agent.tickets.*') ? 'active' : ''); ?>">Queue</a>
            <a href="<?php echo e(route('portal.index')); ?>" class="nav-pill">Portal</a>
            <a href="<?php echo e(route('agent.settings.index')); ?>" class="nav-pill <?php echo e(Request::routeIs('agent.settings.*') ? 'active' : ''); ?>">Settings</a>
            <div class="nav-avatar" title="<?php echo e(auth()->user()?->name); ?>"><?php echo e(strtoupper(substr(auth()->user()?->name ?? 'GU', 0, 2))); ?></div>
            <a href="<?php echo e(route('logout')); ?>" class="text-xs text-white/60 hover:text-white ml-2">Logout</a>
        </div>
        ...
        <div class="body-wrapper">
            ...
            <div class="sidebar">
                ...
                <a href="<?php echo e(route('agent.settings.index')); ?>" class="sidebar-item <?php echo e(Request::routeIs('agent.settings.*') ? 'active' : ''); ?>">
