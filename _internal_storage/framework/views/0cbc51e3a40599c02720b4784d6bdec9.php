<div class="max-w-3xl mx-auto card-ds">
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e($type === 'change' ? 'Create Change Request' : ($type === 'problem' ? 'Add New Problem' : 'Create New Ticket')); ?></h1>

    <?php $routePrefix = request()->is('admin/*') ? 'admin' : 'agent'; ?>
    <form method="POST" action="<?php echo e(route($routePrefix . '.tickets.store')); ?>" enctype="multipart/form-data" wire:submit.prevent="save" class="space-y-6">
        <?php echo csrf_field(); ?>
        <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['requester_id'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700">
                Team
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type, ['problem', 'change'], true)): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex justify-end pt-4">
            <button type="submit" class="btn-ds primary">
                <?php echo e($type === 'change' ? 'Create Change Request' : ($type === 'problem' ? 'Add New Problem' : 'Create Ticket')); ?>
...
<?php /**PATH C:\xampp\htdocs\serviceflow\resources\views/livewire/tickets/create-ticket.blade.php ENDPATH**/ ?>