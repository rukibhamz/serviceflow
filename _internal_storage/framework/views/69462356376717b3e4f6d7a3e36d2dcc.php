<div x-data class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            ...
            <p class="text-3xl font-bold text-gray-800"><?php echo e($counters['open'] ?? 0); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            <p class="text-xs text-gray-500 uppercase tracking-wide mb-1">Unassigned</p>
            <p class="text-3xl font-bold text-orange-500"><?php echo e($counters['unassigned'] ?? 0); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            <p class="text-xs text-gray-500 uppercase tracking-wide mb-1">SLA Breaches</p>
            <p class="text-3xl font-bold text-red-500"><?php echo e($counters['breached'] ?? 0); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            <p class="text-xs text-gray-500 uppercase tracking-wide mb-1">Resolved Today</p>
            <p class="text-3xl font-bold text-green-600"><?php echo e($counters['resolved_today'] ?? 0); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            ...
            <p class="text-xs text-gray-400 mb-3">Average: <span class="font-semibold text-gray-700"><?php echo e($csatChart['average'] ?? '—'); ?></span> / 5</p>
