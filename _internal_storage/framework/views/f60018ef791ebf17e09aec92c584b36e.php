...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex gap-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article && $article->exists && $article->status !== 'published'): ?>
                <button
                    wire:click="publish"
...
<?php /**PATH C:\xampp\htdocs\serviceflow\resources\views\livewire\knowledge\article-editor.blade.php ENDPATH**/ ?>