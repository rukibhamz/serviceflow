...
<head>
    ...
    <title>Sign In — <?php echo e(app(\App\Services\SettingService::class)->get('brand_name', config('app.name', 'ServiceFlow'))); ?></title>
...
<div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
    ...
    <div class="mb-6 text-center">
        <h1 class="text-2xl font-bold text-gray-800"><?php echo e(app(\App\Services\SettingService::class)->get('brand_name', config('app.name', 'ServiceFlow'))); ?></h1>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ssoEnabled): ?>
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.google.client_id') && $settings->get('sso_google_enabled', true)): ?>
        <a href="<?php echo e(route('auth.sso.redirect', 'google')); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.azure.client_id') && $settings->get('sso_microsoft_enabled', true)): ?>
        <a href="<?php echo e(route('auth.sso.redirect', 'microsoft')); ?>"
           class="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.github.client_id') && $settings->get('sso_github_enabled', true)): ?>
        <a href="<?php echo e(route('auth.sso.redirect', 'github')); ?>"
           class="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.atlassian.client_id') && $settings->get('sso_atlassian_enabled', true)): ?>
        <a href="<?php echo e(route('auth.sso.redirect', 'atlassian')); ?>"
           class="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('services.slack-openid.client_id') && $settings->get('sso_slack_enabled', true)): ?>
        <a href="<?php echo e(route('auth.sso.redirect', 'slack')); ?>"
           class="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('sso_error')): ?>
    <p class="mt-3 text-xs text-red-500 text-center"><?php echo e(session('sso_error')); ?></p>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
