...
<div class="space-y-6">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('mail_saved')): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('mail_test_result')): ?>
        <div class="flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg text-sm">
            ...
            <?php echo e(session('mail_test_result')); ?>

        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('sso_saved')): ?>
        <div class="flex items-center gap-2 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg text-sm">
            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
    ...
    <div class="card-ds">
        ...
        <div class="card-body space-y-4">
            <form method="POST" action="<?php echo e(route('admin.settings.mail.save')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="form-group">
                        ...
                        <select name="mail_mailer" class="form-input-ds">
                            <option value="smtp" <?php echo e($mailMailer === 'smtp' ? 'selected' : ''); ?>>SMTP</option>
                            <option value="log" <?php echo e($mailMailer === 'log' ? 'selected' : ''); ?>>Log (dev)</option>
                            <option value="array" <?php echo e($mailMailer === 'array' ? 'selected' : ''); ?>>Array (test)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="form-group"><label class="form-label">SMTP Host</label><input type="text" name="mail_host" value="<?php echo e($mailHost); ?>" class="form-input-ds" placeholder="smtp.gmail.com"></div>
                        <div class="form-group"><label class="form-label">SMTP Port</label><input type="number" name="mail_port" value="<?php echo e($mailPort); ?>" class="form-input-ds" placeholder="587"></div>
                        <div class="form-group"><label class="form-label">Username</label><input type="text" name="mail_username" value="<?php echo e($mailUser); ?>" class="form-input-ds"></div>
                        <div class="form-group"><label class="form-label">Password / App Password</label><input type="text" name="mail_password" value="<?php echo e($mailPass); ?>" class="form-input-ds"></div>
                        <div class="form-group"><label class="form-label">Encryption</label>
                            <select name="mail_encryption" class="form-input-ds">
                                <option value="">None</option>
                                <option value="tls" <?php echo e($mailEnc === 'tls' ? 'selected' : ''); ?>>TLS</option>
                                <option value="ssl" <?php echo e($mailEnc === 'ssl' ? 'selected' : ''); ?>>SSL</option>
                            </select>
                        </div>
                        <div class="form-group"><label class="form-label">From Address</label><input type="email" name="mail_from_address" value="<?php echo e($mailFromAddress); ?>" class="form-input-ds"></div>
                        <div class="form-group md:col-span-2"><label class="form-label">From Name</label><input type="text" name="mail_from_name" value="<?php echo e($mailFromName); ?>" class="form-input-ds"></div>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="text-xs flex items-center gap-2 text-gray-600">
                            <input type="checkbox" name="mail_inbound_enabled" value="1" class="rounded border-gray-300" <?php echo e($inboundEnabled ? 'checked' : ''); ?>>
                            Enabled
                        </label>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div class="form-group"><label class="form-label">Protocol</label>
                            <select name="mail_inbound_protocol" class="form-input-ds">
                                <option value="imap" <?php echo e($inboundProtocol === 'imap' ? 'selected' : ''); ?>>IMAP (poll inbox)</option>
                                <option value="piped" <?php echo e($inboundProtocol === 'piped' ? 'selected' : ''); ?>>Piped email (stdin to artisan email:ingest)</option>
                            </select>
                        </div>
                        <div class="form-group"><label class="form-label">Inbox Folder</label><input type="text" name="mail_inbound_folder" value="<?php echo e($inboundFolder); ?>" class="form-input-ds" placeholder="INBOX"></div>
                        <div class="form-group"><label class="form-label">IMAP Host</label><input type="text" name="mail_inbound_host" value="<?php echo e($inboundHost); ?>" class="form-input-ds" placeholder="imap.gmail.com"></div>
                        <div class="form-group"><label class="form-label">IMAP Port</label><input type="number" name="mail_inbound_port" value="<?php echo e($inboundPort); ?>" class="form-input-ds" placeholder="993"></div>
                        <div class="form-group"><label class="form-label">IMAP Username</label><input type="text" name="mail_inbound_username" value="<?php echo e($inboundUser); ?>" class="form-input-ds"></div>
                        <div class="form-group"><label class="form-label">IMAP Password</label><input type="text" name="mail_inbound_password" value="<?php echo e($inboundPass); ?>" class="form-input-ds"></div>
                        <div class="form-group"><label class="form-label">IMAP Encryption</label>
                            <select name="mail_inbound_encryption" class="form-input-ds">
                                <option value="tls" <?php echo e($inboundEncryption === 'tls' ? 'selected' : ''); ?>>TLS</option>
                                <option value="ssl" <?php echo e($inboundEncryption === 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                <option value="none" <?php echo e($inboundEncryption === 'none' ? 'selected' : ''); ?>>None</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" action="<?php echo e(route('admin.settings.mail.test')); ?>" class="border-t border-gray-100 pt-4">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
                    <div class="form-group md:col-span-2">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['mail_test'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="card-ds">
        ...
        <div class="card-body space-y-4">
            <form method="POST" action="<?php echo e(route('admin.settings.sso.save')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <label class="flex items-center gap-2 text-sm text-gray-700">
                    <input type="checkbox" name="sso_enabled" value="1" class="rounded border-gray-300" <?php echo e(old('sso_enabled', $ssoEnabled) ? 'checked' : ''); ?>>
                        ...
                        <div class="p-4 border border-gray-200 rounded-lg space-y-3">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-800">
                                    ...
                                    <span class="ml-2 text-xs <?php echo e($configured ? 'text-green-600' : 'text-amber-600'); ?>">
                                        <?php echo e($configured ? 'configured' : 'missing keys'); ?>

                                    </span>
                                </span>
                                <label class="text-xs flex items-center gap-2 text-gray-600">
                                    <input type="checkbox" name="<?php echo e($flag); ?>" value="1" class="rounded border-gray-300" <?php echo e(old($flag, $isEnabled) ? 'checked' : ''); ?>>
                                    Enabled
                                </label>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="<?php echo e($clientIdKey); ?>" value="<?php echo e($clientIdVal); ?>" class="form-input-ds" placeholder="<?php echo e(strtoupper($key)); ?> client ID">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Client Secret</label>
                                    <input type="text" name="<?php echo e($clientSecretKey); ?>" value="<?php echo e($clientSecretVal); ?>" class="form-input-ds" placeholder="<?php echo e(strtoupper($key)); ?> client secret">
                                </div>
                                <div class="form-group md:col-span-2">
                                    <label class="form-label">Redirect URL</label>
                                    <input type="url" name="<?php echo e($redirectKey); ?>" value="<?php echo e($redirectVal); ?>" class="form-input-ds" placeholder="<?php echo e(url('/auth/'.$key.'/callback')); ?>">
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($provider['has_tenant']): ?>
                                    <div class="form-group md:col-span-2">
                                        <label class="form-label">Tenant</label>
                                        <input type="text" name="<?php echo e($tenantKey); ?>" value="<?php echo e($tenantVal); ?>" class="form-input-ds" placeholder="common or your tenant ID">
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
    ...
    <div x-data="{ primary: '<?php echo e($curPrimary); ?>', accent: '<?php echo e($curAccent); ?>', name: '<?php echo e(addslashes($curName)); ?>' }">
        <form method="POST" action="<?php echo e(route('admin.settings.branding.save')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            <div class="card-ds">
                ...
                <div class="card-body space-y-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="brand_name" value="<?php echo e(old('brand_name', $curName)); ?>" x-on:input="name = $event.target.value" class="form-input-ds max-w-sm" required>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-24 h-14 rounded-lg border border-gray-200 flex items-center justify-center bg-gray-50 overflow-hidden flex-shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($curLogo): ?><img src="<?php echo e($curLogo); ?>" class="h-full w-full object-contain p-1"><?php else: ?><span class="text-xs text-gray-300">No logo</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div class="flex-1 min-w-0">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($curLogo): ?><label class="flex items-center gap-1.5 mt-1.5 cursor-pointer text-xs text-red-400 hover:text-red-600"><input type="checkbox" name="remove_logo" value="1" class="rounded">Remove logo</label><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-14 h-14 rounded-lg border border-gray-200 flex items-center justify-center bg-gray-50 overflow-hidden flex-shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($all['brand_favicon'] ?? null): ?><img src="<?php echo e($curFavicon); ?>" class="w-8 h-8 object-contain"><?php else: ?><span class="text-xs text-gray-300">None</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div class="flex-1 min-w-0">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($all['brand_favicon'] ?? null): ?><label class="flex items-center gap-1.5 mt-1.5 cursor-pointer text-xs text-red-400 hover:text-red-600"><input type="checkbox" name="remove_favicon" value="1" class="rounded">Remove favicon</label><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $presets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="cursor-pointer">
                                    <input type="radio" name="theme_preset" value="<?php echo e($key); ?>" <?php echo e(old('theme_preset', $curPreset) === $key ? 'checked' : ''); ?> class="sr-only peer"
                                           <?php if($key !== 'custom'): ?>
                                           x-on:change="
                                               ...
                                               document.getElementById('inp_primary_txt').value = '<?php echo e($preset['primary']); ?>';
                                               document.getElementById('inp_accent_txt').value  = '<?php echo e($preset['accent']); ?>';
                                           "
                                           <?php endif; ?>>
                                    <div class="relative flex flex-col items-center gap-2 p-3 rounded-xl border-2 border-gray-100 peer-checked:border-blue-500 peer-checked:bg-blue-50/40 bg-white hover:bg-gray-50 transition select-none">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($key !== 'custom'): ?>
                                            <div class="flex gap-1.5"><div class="w-6 h-6 rounded-full shadow border border-black/10" style="background:<?php echo e($preset['primary']); ?>"></div><div class="w-6 h-6 rounded-full shadow border border-black/10" style="background:<?php echo e($preset['accent']); ?>"></div></div>
                                        <?php else: ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="color" id="inp_primary" name="theme_primary" value="<?php echo e(old('theme_primary', $curPrimary)); ?>"
                                ...
                                <input type="text" id="inp_primary_txt" value="<?php echo e(old('theme_primary', $curPrimary)); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="color" id="inp_accent" name="theme_accent" value="<?php echo e(old('theme_accent', $curAccent)); ?>"
                                       x-on:input="accent = $event.target.value; document.getElementById('inp_accent_txt').value = $event.target.value"
                                       class="w-10 h-9 rounded border border-gray-200 cursor-pointer p-0.5 flex-shrink-0">
                                <input type="text" id="inp_accent_txt" value="<?php echo e(old('theme_accent', $curAccent)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\serviceflow\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>