...
<div class="stats-ds mb-4">
    <div class="stat-card">
        ...
        <div class="stat-val text-brand"><?php echo e($total); ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Open</div>
        <div class="stat-val text-red-500"><?php echo e($open); ?></div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Known Errors (KEDB)</div>
        <div class="stat-val text-orange-500"><?php echo e($knownErrors); ?></div>
    </div>
</div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-4207483975-0', $__key);
...
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\serviceflow\resources\views/agent/itsm/problems.blade.php ENDPATH**/ ?>