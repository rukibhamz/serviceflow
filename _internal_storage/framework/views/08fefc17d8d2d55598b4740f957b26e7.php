...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button wire:click="<?php echo e($editingTeamId ? 'updateTeam' : 'createTeam'); ?>" class="rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
...
<?php /**PATH C:\xampp\htdocs\serviceflow\resources\views\livewire\admin\team-manager.blade.php ENDPATH**/ ?>