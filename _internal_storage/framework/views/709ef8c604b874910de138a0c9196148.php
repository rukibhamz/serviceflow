    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCreating): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
                ...
                <form method="POST" action="<?php echo e($editingTeamId ? route('admin.teams.update', $editingTeamId) : route('admin.teams.store')); ?>" wire:submit.prevent="saveTeam" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        <a href="<?php echo e(route('admin.teams')); ?>" class="text-sm font-medium text-gray-600 hover:text-gray-900">Cancel</a>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTeamId): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div class="w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
                ...
                <form method="POST" action="<?php echo e(route('admin.teams.members.update', $selectedTeamId)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="max-h-96 overflow-y-auto space-y-2 pr-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allAgents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center gap-3 rounded border border-gray-100 p-2 hover:bg-gray-50 cursor-pointer">
                                <input type="checkbox" name="selectedAgents[]" value="<?php echo e($agent->id); ?>" <?php if(in_array($agent->id, $selectedAgents, true)): echo 'checked'; endif; ?> class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                                <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
                            <a href="<?php echo e(route('admin.teams', ['members' => $team->id])); ?>" class="text-blue-600 hover:text-blue-900">Members</a>
                            <a href="<?php echo e(route('admin.teams', ['edit' => $team->id])); ?>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            <form method="POST" action="<?php echo e(route('admin.teams.destroy', $team)); ?>" class="inline" onsubmit="return confirm('Delete this team?')">
                                <?php echo csrf_field(); ?>
